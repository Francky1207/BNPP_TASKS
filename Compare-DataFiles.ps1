...
function Write-ResultatsExcel {
    ...
    try {
        ...
        for ($i = 0; $i -lt $total; $i++) {
            ...
            $ws.Cells.Item($lx, 1).Value2 = $r.STATUT
            $ws.Cells.Item($lx, 2).Value2 = $r.LIGNE_1
            $ws.Cells.Item($lx, 3).Value2 = $r.VALEUR_1
            $ws.Cells.Item($lx, 4).Value2 = $r.LIGNE_2
            $ws.Cells.Item($lx, 5).Value2 = $r.VALEUR_2
            $ws.Cells.Item($lx, 6).Value2 = $r.CLE
            $ws.Cells.Item($lx, 7).Value2 = $r.COLONNE
            $ws.Cells.Item($lx, 8).Value2 = $r.DETAIL
